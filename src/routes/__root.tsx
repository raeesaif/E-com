...
import { AppStateProvider } from "../components/marketplace/AppState";
...
const themeInitScript = `(function(){try{var t=localStorage.getItem('market-theme');if(t==='dark')document.documentElement.classList.add('dark');}catch(e){}})();`;
